--  ----------------------------------------------------------------------------------------------------
--
--  FILE NAME      : ACTIVES2_iScripts.SQL
--  DESCRIPTION    : Active sessions, more data like sql, chids, times + scripts
--  AUTHOR         : Antonio NAVARRO - /\/\/
--  CREATE         : 28.10.18
--  LAST MODIFIED  : 16.02.19
--  USAGE          : Active sessions, more heavy query and more data like sql, chids, times plus 
--                 : scripts 
--  CALL SYNTAXIS  : @actives2_iScripts.sql
--  [NOTES]        :
--   
--  ----------------------------------------------------------------------------------------------------
...
PRO 
PRO @killer     [sid] || [username] || [sqlid]
PRO @sqlhc T    [sqlid]                              @sqlxtract  [sqlid]                @bind_variables  [sqlid]     
PRO @ratio_miss [sid]                                @show_sqlid [sqlid]               
PRO
PRO --------------------------------------------------------------------------------------------------------------
